{ pkgs ? import <nixpkgs> { system = "x86_64-darwin"; } }:
  let
    binutils-mips64-elf = (import ./binutils-mips64-elf.nix (with pkgs; {inherit lib stdenv gnumake gcc;}));
    gcc-mips64-elf = (import ./gcc-mips64-elf.nix (with pkgs; {inherit lib stdenv gmp isl libmpc mpfr binutils-mips64-elf;}));
  in
  pkgs.mkShell {
